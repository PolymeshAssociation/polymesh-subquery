...
declare module '@polkadot/api/types/storage' {
  export interface AugmentedQueries<ApiType> {
    asset: {
       ...
       **/
      aggregateBalance: AugmentedQuery<ApiType, (arg1: Ticker | string | Uint8Array, arg2: ScopeId | string | Uint8Array) => Observable<Balance>, [Ticker, ScopeId]>;
      /**
       * Documents attached to an Asset
       * (ticker, doc_id) -> document
       **/
      assetDocuments: AugmentedQuery<ApiType, (arg1: Ticker | string | Uint8Array, arg2: DocumentId | AnyNumber | Uint8Array) => Observable<Document>, [Ticker, DocumentId]>;
      /**
       ...
       **/
      assetOwnershipRelations: AugmentedQuery<ApiType, (arg1: IdentityId | string | Uint8Array, arg2: Ticker | string | Uint8Array) => Observable<AssetOwnershipRelation>, [IdentityId, Ticker]>;
      /**
       * The total asset ticker balance per identity.
       * (ticker, DID) -> Balance
       **/
      balanceOf: AugmentedQuery<ApiType, (arg1: Ticker | string | Uint8Array, arg2: IdentityId | string | Uint8Array) => Observable<Balance>, [Ticker, IdentityId]>;
      /**
       ...
       **/
      balanceOfAtScope: AugmentedQuery<ApiType, (arg1: ScopeId | string | Uint8Array, arg2: IdentityId | string | Uint8Array) => Observable<Balance>, [ScopeId, IdentityId]>;
      /**
       ...
       **/
      scopeIdOf: AugmentedQuery<ApiType, (arg1: Ticker | string | Uint8Array, arg2: IdentityId | string | Uint8Array) => Observable<ScopeId>, [Ticker, IdentityId]>;
      /**
       * Storage version.
       **/
    ...
    bridge: {
       ...
       **/
      bridgeTxDetails: AugmentedQuery<ApiType, (arg1: AccountId | string | Uint8Array, arg2: u32 | AnyNumber | Uint8Array) => Observable<BridgeTxDetail>, [AccountId, u32]>;
      /**
    ...
    checkpoint: {
       ...
       **/
      balance: AugmentedQuery<ApiType, (arg1: ITuple<[Ticker, CheckpointId]> | [Ticker | string | Uint8Array, CheckpointId | AnyNumber | Uint8Array], arg2: IdentityId | string | Uint8Array) => Observable<Balance>, [ITuple<[Ticker, CheckpointId]>, IdentityId]>;
      /**
       * Checkpoints where a DID's balance was updated.
       * (ticker, did) -> [checkpoint ID where user balance changed]
       **/
      balanceUpdates: AugmentedQuery<ApiType, (arg1: Ticker | string | Uint8Array, arg2: IdentityId | string | Uint8Array) => Observable<Vec<CheckpointId>>, [Ticker, IdentityId]>;
      /**
       ...
       **/
      schedulePoints: AugmentedQuery<ApiType, (arg1: Ticker | string | Uint8Array, arg2: ScheduleId | AnyNumber | Uint8Array) => Observable<Vec<CheckpointId>>, [Ticker, ScheduleId]>;
      /**
       ...
       **/
      scheduleRefCount: AugmentedQuery<ApiType, (arg1: Ticker | string | Uint8Array, arg2: ScheduleId | AnyNumber | Uint8Array) => Observable<u32>, [Ticker, ScheduleId]>;
      /**
       ...
       **/
      timestamps: AugmentedQuery<ApiType, (arg1: Ticker | string | Uint8Array, arg2: CheckpointId | AnyNumber | Uint8Array) => Observable<Moment>, [Ticker, CheckpointId]>;
      /**
       * Total supply of the token at the checkpoint.
       * 
       * (ticker, checkpointId) -> total supply at given checkpoint
       **/
      totalSupply: AugmentedQuery<ApiType, (arg1: Ticker | string | Uint8Array, arg2: CheckpointId | AnyNumber | Uint8Array) => Observable<Balance>, [Ticker, CheckpointId]>;
    };
    committeeMembership: {
      /**
       * The current "active" membership, stored as an ordered Vec.
    ...
    corporateAction: {
       ...
       * (ticker => did?)
       **/
      agent: AugmentedQuery<ApiType, (arg: Ticker | string | Uint8Array) => Observable<Option<IdentityId>>, [Ticker]>;
      /**
       ...
       **/
      corporateActions: AugmentedQuery<ApiType, (arg1: Ticker | string | Uint8Array, arg2: LocalCAId | AnyNumber | Uint8Array) => Observable<Option<CorporateAction>>, [Ticker, LocalCAId]>;
      /**
    ...
    corporateBallot: {
       ...
       **/
      votes: AugmentedQuery<ApiType, (arg1: CAId | { ticker?: any; local_id?: any } | string | Uint8Array, arg2: IdentityId | string | Uint8Array) => Observable<Vec<BallotVote>>, [CAId, IdentityId]>;
    };
    grandpa: {
      /**
    ...
    identity: {
       ...
       **/
      authorizations: AugmentedQuery<ApiType, (arg1: Signatory | { Identity: any } | { Account: any } | string | Uint8Array, arg2: u64 | AnyNumber | Uint8Array) => Observable<Authorization>, [Signatory, u64]>;
      /**
       * All authorizations that an identity has given. (Authorizer, auth_id -> authorized)
       **/
      authorizationsGiven: AugmentedQuery<ApiType, (arg1: IdentityId | string | Uint8Array, arg2: u64 | AnyNumber | Uint8Array) => Observable<Signatory>, [IdentityId, u64]>;
      /**
       ...
       **/
      claims: AugmentedQuery<ApiType, (arg1: Claim1stKey | { target?: any; claim_type?: any } | string | Uint8Array, arg2: Claim2ndKey | { issuer?: any; scope?: any } | string | Uint8Array) => Observable<IdentityClaim>, [Claim1stKey, Claim2ndKey]>;
      /**
    ...
    multiSig: {
       ...
       **/
      multiSigSigners: AugmentedQuery<ApiType, (arg1: AccountId | string | Uint8Array, arg2: Signatory | { Identity: any } | { Account: any } | string | Uint8Array) => Observable<Signatory>, [AccountId, Signatory]>;
      /**
       ...
       **/
      proposalIds: AugmentedQuery<ApiType, (arg1: AccountId | string | Uint8Array, arg2: Proposal | { callIndex?: any; args?: any } | string | Uint8Array) => Observable<Option<u64>>, [AccountId, Proposal]>;
      /**
    ...
    pips: {
       ...
       **/
      deposits: AugmentedQuery<ApiType, (arg1: PipId | AnyNumber | Uint8Array, arg2: AccountId | string | Uint8Array) => Observable<DepositInfo>, [PipId, AccountId]>;
      /**
       ...
       **/
      proposalVotes: AugmentedQuery<ApiType, (arg1: PipId | AnyNumber | Uint8Array, arg2: AccountId | string | Uint8Array) => Observable<Option<Vote>>, [PipId, AccountId]>;
      /**
    ...
    portfolio: {
       ...
       **/
      portfolioAssetBalances: AugmentedQuery<ApiType, (arg1: PortfolioId | { did?: any; kind?: any } | string | Uint8Array, arg2: Ticker | string | Uint8Array) => Observable<Balance>, [PortfolioId, Ticker]>;
      /**
       ...
       **/
      portfolioLockedAssets: AugmentedQuery<ApiType, (arg1: PortfolioId | { did?: any; kind?: any } | string | Uint8Array, arg2: Ticker | string | Uint8Array) => Observable<Balance>, [PortfolioId, Ticker]>;
      /**
       ...
       **/
      portfolios: AugmentedQuery<ApiType, (arg1: IdentityId | string | Uint8Array, arg2: PortfolioNumber | AnyNumber | Uint8Array) => Observable<PortfolioName>, [IdentityId, PortfolioNumber]>;
      /**
       ...
       **/
      portfoliosInCustody: AugmentedQuery<ApiType, (arg1: IdentityId | string | Uint8Array, arg2: PortfolioId | { did?: any; kind?: any } | string | Uint8Array) => Observable<bool>, [IdentityId, PortfolioId]>;
      /**
       * Storage version.
       **/
      storageVersion: AugmentedQuery<ApiType, () => Observable<Version>, []>;
    ...
    settlement: {
       ...
       **/
      affirmsReceived: AugmentedQuery<ApiType, (arg1: u64 | AnyNumber | Uint8Array, arg2: PortfolioId | { did?: any; kind?: any } | string | Uint8Array) => Observable<AffirmationStatus>, [u64, PortfolioId]>;
      /**
       ...
       **/
      instructionLegs: AugmentedQuery<ApiType, (arg1: u64 | AnyNumber | Uint8Array, arg2: u64 | AnyNumber | Uint8Array) => Observable<Leg>, [u64, u64]>;
      /**
       * Status of a leg under an instruction. (instruction_id, leg_id) -> LegStatus
       **/
      instructionLegStatus: AugmentedQuery<ApiType, (arg1: u64 | AnyNumber | Uint8Array, arg2: u64 | AnyNumber | Uint8Array) => Observable<LegStatus>, [u64, u64]>;
      /**
       * Tracks redemption of receipts. (signer, receipt_uid) -> receipt_used
       **/
      receiptsUsed: AugmentedQuery<ApiType, (arg1: AccountId | string | Uint8Array, arg2: u64 | AnyNumber | Uint8Array) => Observable<bool>, [AccountId, u64]>;
      /**
       * Storage version.
       **/
      storageVersion: AugmentedQuery<ApiType, () => Observable<Version>, []>;
       ...
       **/
      userAffirmations: AugmentedQuery<ApiType, (arg1: PortfolioId | { did?: any; kind?: any } | string | Uint8Array, arg2: u64 | AnyNumber | Uint8Array) => Observable<AffirmationStatus>, [PortfolioId, u64]>;
      /**
       ...
       **/
      venueAllowList: AugmentedQuery<ApiType, (arg1: Ticker | string | Uint8Array, arg2: u64 | AnyNumber | Uint8Array) => Observable<bool>, [Ticker, u64]>;
      /**
       ...
       **/
      venueSigners: AugmentedQuery<ApiType, (arg1: u64 | AnyNumber | Uint8Array, arg2: AccountId | string | Uint8Array) => Observable<bool>, [u64, AccountId]>;
    };
    staking: {
      /**
    ...
    statistics: {
       ...
       **/
      exemptEntities: AugmentedQuery<ApiType, (arg1: ITuple<[Ticker, TransferManager]> | [Ticker | string | Uint8Array, TransferManager | { CountTransferManager: any } | { PercentageTransferManager: any } | string | Uint8Array], arg2: ScopeId | string | Uint8Array) => Observable<bool>, [ITuple<[Ticker, TransferManager]>, ScopeId]>;
      /**
    ...
    sto: {
       ...
       **/
      fundraiserNames: AugmentedQuery<ApiType, (arg1: Ticker | string | Uint8Array, arg2: u64 | AnyNumber | Uint8Array) => Observable<FundraiserName>, [Ticker, u64]>;
      /**
       * All fundraisers that are currently running.
       * (ticker, fundraiser_id) -> Fundraiser
       **/
      fundraisers: AugmentedQuery<ApiType, (arg1: Ticker | string | Uint8Array, arg2: u64 | AnyNumber | Uint8Array) => Observable<Option<Fundraiser>>, [Ticker, u64]>;
    };
    sudo: {
      /**
