alter type "7a0b4cc03e" add value if not exists 'statetriemigration' after 'nft';

alter type "0bf3c7d4ef" add value if not exists 'continue_migrate' after 'redeem_nft';
