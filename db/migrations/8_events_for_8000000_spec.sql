...
alter type "8f5a39c8ee" add value if not exists 'TransferWithMemo' after 'TotalIssuanceForced';
alter type "8f5a39c8ee" add value if not exists 'Unlocked' after 'TransferWithMemo';
