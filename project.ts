...
const filters: Record<string, Record<string, string[]>> = {
  asset: {
    ...
    LocalMetadataKeyDeleted: ['handleLocalMetadataKeyDeleted'],
    MetadataValueDeleted: ['handleMetadataValueDeleted'],
    PreApprovedAsset: ['handlePreApprovedAsset'],
    RegisterAssetMetadataGlobalType: ['handleRegisterAssetMetadataGlobalType'],
    RegisterAssetMetadataLocalType: ['handleRegisterAssetMetadataLocalType'],
  ...
  // the `confidentialAsset` pallet (v1) was replaced by `confidentialAssets` in 8.0.0 and was
  ...
  staking: {
    ...
    SlashReported: ['handleStakingEvent'],
  ...
  confidentialAssets: {
    AccountRegistered: ['handleConfidentialAccountRegistered'],
    EncryptionKeyRegistered: ['handleConfidentialEncryptionKeyRegistered'],
    AssetCreated: ['handleConfidentialAssetCreated'],
    AssetUpdated: ['handleConfidentialAssetUpdated'],
    AccountAssetRegistered: ['handleConfidentialAccountAssetRegistered'],
    AssetMinted: ['handleConfidentialAssetMinted'],
    FeeAccountUpdated: [],
    SettlementCreated: ['handleConfidentialSettlementCreated'],
    SenderAffirmed: ['handleConfidentialLegPartyUpdated'],
    ReceiverAffirmed: ['handleConfidentialLegPartyUpdated'],
    MediatorAffirmed: ['handleConfidentialLegPartyUpdated'],
    MediatorRejected: ['handleConfidentialLegPartyUpdated'],
    SenderCounterUpdated: ['handleConfidentialLegPartyUpdated'],
    SenderAffirmationReverted: ['handleConfidentialLegPartyUpdated'],
    ReceiverAffirmationReverted: ['handleConfidentialLegPartyUpdated'],
    ReceiverClaimed: ['handleConfidentialLegPartyUpdated'],
    SettlementStatusUpdated: ['handleConfidentialSettlementStatusUpdated'],
    AccountStateLeafInserted: ['handleConfidentialCurveTreeLeafUpdated'],
    FeeAccountStateLeafInserted: ['handleConfidentialCurveTreeLeafUpdated'],
    AssetStateLeafUpdated: ['handleConfidentialCurveTreeLeafUpdated'],
